...
Open het bestand “form1.php” en test het zelf maar eens. Verzend je naam en kijk wat er gebeurt met de URL in de adresbalk van je browser.
...
Het **name-attribuut** is niet verplicht, maar die heb je wel altijd nodig behalve bij de submit-knop. Je hebt vast al gezien dat de “name” die hier is ingevoerd in de URL terug kwam toen je het formulier verstuurde: form1.php?naam=Paulus. Daar moeten we nog iets mee doen…
